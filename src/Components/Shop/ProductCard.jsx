      ...
      <div className="relative group overflow-hidden cursor-pointer ">
        ...
        <div className="absolute -bottom-12 w-full flex justify-center items-center group-hover:bottom-5 transition-all duration-700 ease-in-out">
          <button
            ...
            } w-[94%] p-3 transition-all duration-300 ease-linear`}
            onClick={() => handleAddToCart(data)}
          >
            {isInCart ? "Items in Car" : "ADD TO CART"}
          </button>
        </div>
          ...
          <button
            className={`${
              isInWish
                ...
                : "bg-lime-200 hover:bg-lime-400"
            } text-2xl  p-3 rounded-full  transition-all duration-300 ease-linear`}
            onClick={() => handleAddtoWish(data)}
          >
            <FaRegHeart />
          </button>
